...
import { type PiecesProps } from "../../helpers";

export default function King({ type, team }: PiecesProps) {
  return (
    <svg id={type} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill={color(team)} className="h-20 p-4">
