...
import { type TeamType } from "../../hooks/useChess";

export default function King({ team }: { team: TeamType }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill={color(team)} className="h-20 p-4">
